 ...
 * @param {string} options.initialTheme initial theme
 * @param {Function} options.setThemeHandler theme handler function
 * @returns {Array} A tuple with properties and methods
 * properties:
