...
`),this._exit(0,"commander.version",e)}),this}description(e,t){return e===void 0&&t===void 0?this._description:(this._description=e,t&&(this._argsDescription=t),this)}summary(e){return e===void 0?this._summary:(this._summary=e,this)}alias(e){if(e===void 0)return this._aliases[0];let t=this;if(this.commands.length!==0&&this.commands[this.commands.length-1]._executableHandler&&(t=this.commands[this.commands.length-1]),e===t._name)throw new Error("Command alias can't be the same as its name");return t._aliases.push(e),this}aliases(e){return e===void 0?this._aliases:(e.forEach(t=>this.alias(t)),this)}usage(e){if(e===void 0){if(this._usage)return this._usage;let t=this._args.map(r=>fg(r));return[].concat(this.options.length||this._hasHelpOption?"[options]":[],this.commands.length?"[command]":[],this._args.length?t:[]).join(" ")}return this._usage=e,this}name(e){return e===void 0?this._name:(this._name=e,this)}nameFromFilename(e){return this._name=Ye.basename(e,Ye.extname(e)),this}executableDir(e){return e===void 0?this._executableDir:(this._executableDir=e,this)}helpInformation(e){let t=this.createHelp();return t.helpWidth===void 0&&(t.helpWidth=e&&e.error?this._outputConfiguration.getErrHelpWidth():this._outputConfiguration.getOutHelpWidth()),t.formatHelp(this,t)}_getHelpContext(e){e=e||{};let t={error:!!e.error},r;return t.error?r=i=>this._outputConfiguration.writeErr(i):r=i=>this._outputConfiguration.writeOut(i),t.write=e.write||r,t.command=this,t}outputHelp(e){let t;typeof e=="function"&&(t=e,e=void 0);let r=this._getHelpContext(e);tn(this).reverse().forEach(s=>s.emit("beforeAllHelp",r)),this.emit("beforeHelp",r);let i=this.helpInformation(r);if(t&&(i=t(i),typeof i!="string"&&!Buffer.isBuffer(i)))throw new Error("outputHelp callback must return a string or a Buffer");r.write(i),this.emit(this._helpLongFlag),this.emit("afterHelp",r),tn(this).forEach(s=>s.emit("afterAllHelp",r))}helpOption(e,t){if(typeof e=="boolean")return this._hasHelpOption=e,this;this._helpFlags=e||this._helpFlags,this._helpDescription=t||this._helpDescription;let r=dg(this._helpFlags);return this._helpShortFlag=r.shortFlag,this._helpLongFlag=r.longFlag,this}help(e){this.outputHelp(e);let t=re.exitCode||0;t===0&&e&&typeof e!="function"&&e.error&&(t=1),this._exit(t,"commander.help","(outputHelp)")}addHelpText(e,t){let r=["beforeAll","before","after","afterAll"];if(!r.includes(e))throw new Error(`Unexpected value for position to addHelpText.
...
`);t=n[e+1]}return e}$n.FOLD_BLOCK=Xo;$n.FOLD_FLOW=dA;$n.FOLD_QUOTED=Ai;$n.foldFlowLines=pA});var xn=_(kp=>{"use strict";var Ke=ce(),lt=Pp(),wi=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),vi=n=>/^(%|---|\.\.\.)/m.test(n);function _A(n,e,t){if(!e||e<0)return!1;let r=e-t,i=n.length;if(i<=r)return!1;for(let s=0,o=0;s<i;++s)if(n[s]===`
`){if(s-o>r)return!0;if(o=s+1,i-o<=r)return!1}return!0}function qn(n,e){let t=JSON.stringify(n);if(e.options.doubleQuotedAsJSON)return t;let{implicitKey:r}=e,i=e.options.doubleQuotedMinMultiLineLength,s=e.indent||(vi(n)?"  ":""),o="",a=0;for(let l=0,c=t[l];c;c=t[++l])if(c===" "&&t[l+1]==="\\"&&t[l+2]==="n"&&(o+=t.slice(a,l)+"\\ ",l+=1,a=l,c="\\"),c==="\\")switch(t[l+1]){case"u":{o+=t.slice(a,l);let u=t.substr(l+2,4);switch(u){case"0000":o+="\\0";break;case"0007":o+="\\a";break;case"000b":o+="\\v";break;case"001b":o+="\\e";break;case"0085":o+="\\N";break;case"00a0":o+="\\_";break;case"2028":o+="\\L";break;case"2029":o+="\\P";break;default:u.substr(0,2)==="00"?o+="\\x"+u.substr(2):o+=t.substr(l,6)}l+=5,a=l+1}break;case"n":if(r||t[l+2]==='"'||t.length<i)l+=1;else{for(o+=t.slice(a,l)+`
...
`)||/[ \t]\n|\n[ \t]/.test(n))return qn(n,e);let t=e.indent||(vi(n)?"  ":""),r="'"+n.replace(/'/g,"''").replace(/\n+/g,`$&
${t}`)+"'";return e.implicitKey?r:lt.foldFlowLines(r,t,lt.FOLD_FLOW,wi(e,!1))}function Ut(n,e){let{singleQuote:t}=e.options,r;if(t===!1)r=qn;else{let i=n.includes('"'),s=n.includes("'");i&&!s?r=zo:s&&!i?r=qn:r=t?zo:qn}return r(n,e)}var Qo;try{Qo=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{Qo=/\n+(?!\n|$)/g}function Ii({comment:n,type:e,value:t},r,i,s){let{blockQuote:o,commentString:a,lineWidth:l}=r.options;if(!o||/\n[\t ]+$/.test(t)||/^\s*$/.test(t))return Ut(t,r);let c=r.indent||(r.forceBlockIndent||vi(t)?"  ":""),u=o==="literal"?!0:o==="folded"||e===Ke.Scalar.BLOCK_FOLDED?!1:e===Ke.Scalar.BLOCK_LITERAL?!0:!_A(t,l,c.length);if(!t)return u?`|
`:`>
...
${c}${M}`}function mA(n,e,t,r){let{type:i,value:s}=n,{actualString:o,implicitKey:a,indent:l,indentStep:c,inFlow:u}=e;if(a&&/[\n[\]{},]/.test(s)||u&&/[[\]{},]/.test(s))return Ut(s,e);if(!s||/^[\n\t ,[\]{}#&*!|>'"%@`]|^[?-]$|^[?-][ \t]|[\n:][ \t]|[ \t]\n|[\n\t ]#|[\n\t :]$/.test(s))return a||u||!s.includes(`
`)?Ut(s,e):Ii(n,e,t,r);if(!a&&!u&&i!==Ke.Scalar.PLAIN&&s.includes(`
`))return Ii(n,e,t,r);if(vi(s)){if(l==="")return e.forceBlockIndent=!0,Ii(n,e,t,r);if(a&&l===c)return Ut(s,e)}let f=s.replace(/\n+/g,`$&
${l}`);if(o){let d=g=>g.default&&g.tag!=="tag:yaml.org,2002:str"&&g.test?.test(f),{compat:h,tags:y}=e.doc.schema;if(y.some(d)||h?.some(d))return Ut(s,e)}return a?f:lt.foldFlowLines(f,l,lt.FOLD_FLOW,wi(e,!1))}function gA(n,e,t,r){let{implicitKey:i,inFlow:s}=e,o=typeof n.value=="string"?n:Object.assign({},n,{value:String(n.value)}),{type:a}=n;a!==Ke.Scalar.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o.value)&&(a=Ke.Scalar.QUOTE_DOUBLE);let l=u=>{switch(u){case Ke.Scalar.BLOCK_FOLDED:case Ke.Scalar.BLOCK_LITERAL:return i||s?Ut(o.value,e):Ii(o,e,t,r);case Ke.Scalar.QUOTE_DOUBLE:return qn(o.value,e);case Ke.Scalar.QUOTE_SINGLE:return zo(o.value,e);case Ke.Scalar.PLAIN:return mA(o,e,t,r);default:return null}},c=l(a);if(c===null){let{defaultKeyType:u,defaultStringType:f}=e.options,d=i&&u||f;if(c=l(d),c===null)throw new Error(`Unsupported default string type ${d}`)}return c}kp.stringifyString=gA});var Mn=_(Zo=>{"use strict";var yA=mi(),ct=W(),EA=kn(),TA=xn();function LA(n,e){let t=Object.assign({blockQuote:!0,commentString:EA.stringifyComment,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trueStr:"true",verifyAliasOrder:!0},n.schema.toStringOptions,e),r;switch(t.collectionStyle){case"block":r=!1;break;case"flow":r=!0;break;default:r=null}return{anchors:new Set,doc:n,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:r,options:t}}function SA(n,e){if(e.tag){let i=n.filter(s=>s.tag===e.tag);if(i.length>0)return i.find(s=>s.format===e.format)??i[0]}let t,r;if(ct.isScalar(e)){r=e.value;let i=n.filter(s=>s.identify?.(r));t=i.find(s=>s.format===e.format)??i.find(s=>!s.format)}else r=e,t=n.find(i=>i.nodeClass&&r instanceof i.nodeClass);if(!t){let i=r?.constructor?.name??typeof r;throw new Error(`Tag not resolved for ${i} value`)}return t}function AA(n,e,{anchors:t,doc:r}){if(!r.directives)return"";let i=[],s=(ct.isScalar(n)||ct.isCollection(n))&&n.anchor;s&&yA.anchorIsValid(s)&&(t.add(s),i.push(`&${s}`));let o=n.tag?n.tag:e.default?null:e.tag;return o&&i.push(r.directives.tagString(o)),i.join(" ")}function IA(n,e,t,r){if(ct.isPair(n))return n.toString(e,t,r);if(ct.isAlias(n)){if(e.doc.directives)return n.toString(e);if(e.resolvedAliases?.has(n))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(n):e.resolvedAliases=new Set([n]),n=n.resolve(e.doc)}let i,s=ct.isNode(n)?n:e.doc.createNode(n,{onTagObj:l=>i=l});i||(i=SA(e.doc.schema.tags,s));let o=AA(s,i,e);o.length>0&&(e.indentAtStart=(e.indentAtStart??0)+o.length+1);let a=typeof i.stringify=="function"?i.stringify(s,e,t,r):ct.isScalar(s)?TA.stringifyString(s,e,t,r):s.toString(e,t,r);return o?ct.isScalar(s)||a[0]==="{"||a[0]==="["?`${o} ${a}`:`${o}
${e.indent}${a}`:a}Zo.createStringifyContext=LA;Zo.stringify=IA});var Mp=_(xp=>{"use strict";var ut=W(),$p=ce(),qp=Mn(),Fn=kn();function wA({key:n,value:e},t,r,i){let{allNullValues:s,doc:o,indent:a,indentStep:l,options:{commentString:c,indentSeq:u,simpleKeys:f}}=t,d=ut.isNode(n)&&n.comment||null;if(f){if(d)throw new Error("With simple keys, key nodes cannot have comments");if(ut.isCollection(n)){let V="With simple keys, collection cannot be used as a key value";throw new Error(V)}}let h=!f&&(!n||d&&e==null&&!t.inFlow||ut.isCollection(n)||(ut.isScalar(n)?n.type===$p.Scalar.BLOCK_FOLDED||n.type===$p.Scalar.BLOCK_LITERAL:typeof n=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!h&&(f||!s),indent:a+l});let y=!1,g=!1,m=qp.stringify(n,t,()=>y=!0,()=>g=!0);if(!h&&!t.inFlow&&m.length>1024){if(f)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");h=!0}if(t.inFlow){if(s||e==null)return y&&r&&r(),m===""?"?":h?`? ${m}`:m}else if(s&&!f||e==null&&h)return m=`? ${m}`,d&&!y?m+=Fn.lineComment(m,t.indent,c(d)):g&&i&&i(),m;y&&(d=null),h?(d&&(m+=Fn.lineComment(m,t.indent,c(d))),m=`? ${m}
${a}:`):(m=`${m}:`,d&&(m+=Fn.lineComment(m,t.indent,c(d))));let L,I,v;ut.isNode(e)?(L=!!e.spaceBefore,I=e.commentBefore,v=e.comment):(L=!1,I=null,v=null,e&&typeof e=="object"&&(e=o.createNode(e))),t.implicitKey=!1,!h&&!d&&ut.isScalar(e)&&(t.indentAtStart=m.length+1),g=!1,!u&&l.length>=2&&!t.inFlow&&!h&&ut.isSeq(e)&&!e.flow&&!e.tag&&!e.anchor&&(t.indent=t.indent.substring(2));let $=!1,M=qp.stringify(e,t,()=>$=!0,()=>g=!0),b=" ";if(d||L||I){if(b=L?`
`:"",I){let V=c(I);b+=`
${Fn.indentComment(V,t.indent)}`}M===""&&!t.inFlow?b===`
`&&(b=`
...
${t.indent}`)}}else(M===""||M[0]===`
`)&&(b="");return m+=b+M,t.inFlow?$&&r&&r():v&&!$?m+=Fn.lineComment(m,t.indent,c(v)):g&&i&&i(),m}xp.stringifyPair=wA});var ta=_(ea=>{"use strict";function vA(n,...e){n==="debug"&&console.log(...e)}function bA(n,e){(n==="debug"||n==="warn")&&(typeof process<"u"&&process.emitWarning?process.emitWarning(e):console.warn(e))}ea.debug=vA;ea.warn=bA});var ia=_(Dp=>{"use strict";var NA=ta(),OA=Mn(),Vt=W(),RA=ce(),na=ot(),Fp="<<";function CA(n,e,{key:t,value:r}){if(n?.doc.schema.merge&&PA(t))if(r=Vt.isAlias(r)?r.resolve(n.doc):r,Vt.isSeq(r))for(let i of r.items)ra(n,e,i);else if(Array.isArray(r))for(let i of r)ra(n,e,i);else ra(n,e,r);else{let i=na.toJS(t,"",n);if(e instanceof Map)e.set(i,na.toJS(r,i,n));else if(e instanceof Set)e.add(i);else{let s=kA(t,i,n),o=na.toJS(r,s,n);s in e?Object.defineProperty(e,s,{value:o,writable:!0,enumerable:!0,configurable:!0}):e[s]=o}}return e}var PA=n=>n===Fp||Vt.isScalar(n)&&n.value===Fp&&(!n.type||n.type===RA.Scalar.PLAIN);function ra(n,e,t){let r=n&&Vt.isAlias(t)?t.resolve(n.doc):t;if(!Vt.isMap(r))throw new Error("Merge sources must be maps or map aliases");let i=r.toJSON(null,n,Map);for(let[s,o]of i)e instanceof Map?e.has(s)||e.set(s,o):e instanceof Set?e.add(s):Object.prototype.hasOwnProperty.call(e,s)||Object.defineProperty(e,s,{value:o,writable:!0,enumerable:!0,configurable:!0});return e}function kA(n,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(Vt.isNode(n)&&t&&t.doc){let r=OA.createStringifyContext(t.doc,{});r.anchors=new Set;for(let s of t.anchors.keys())r.anchors.add(s.anchor);r.inFlow=!0,r.inStringifyKey=!0;let i=n.toString(r);if(!t.mapKeyWarned){let s=JSON.stringify(i);s.length>40&&(s=s.substring(0,36)+'..."'),NA.warn(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${s}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return i}return JSON.stringify(e)}Dp.addPairToJSMap=CA});var ft=_(sa=>{"use strict";var jp=Cn(),$A=Mp(),qA=ia(),bi=W();function xA(n,e,t){let r=jp.createNode(n,void 0,t),i=jp.createNode(e,void 0,t);return new Ni(r,i)}var Ni=class n{constructor(e,t=null){Object.defineProperty(this,bi.NODE_TYPE,{value:bi.PAIR}),this.key=e,this.value=t}clone(e){let{key:t,value:r}=this;return bi.isNode(t)&&(t=t.clone(e)),bi.isNode(r)&&(r=r.clone(e)),new n(t,r)}toJSON(e,t){let r=t?.mapAsMap?new Map:{};return qA.addPairToJSMap(t,r,this)}toString(e,t,r){return e?.doc?$A.stringifyPair(this,e,t,r):JSON.stringify(this)}};sa.Pair=Ni;sa.createPair=xA});var oa=_(Bp=>{"use strict";var MA=Pn(),St=W(),Hp=Mn(),Dn=kn();function FA(n,e,t){return(e.inFlow??n.flow?jA:DA)(n,e,t)}function DA({comment:n,items:e},t,{blockItemPrefix:r,flowChars:i,itemIndent:s,onChompKeep:o,onComment:a}){let{indent:l,options:{commentString:c}}=t,u=Object.assign({},t,{indent:s,type:null}),f=!1,d=[];for(let y=0;y<e.length;++y){let g=e[y],m=null;if(St.isNode(g))!f&&g.spaceBefore&&d.push(""),Oi(t,d,g.commentBefore,f),g.comment&&(m=g.comment);else if(St.isPair(g)){let I=St.isNode(g.key)?g.key:null;I&&(!f&&I.spaceBefore&&d.push(""),Oi(t,d,I.commentBefore,f))}f=!1;let L=Hp.stringify(g,u,()=>m=null,()=>f=!0);m&&(L+=Dn.lineComment(L,s,c(m))),f&&m&&(f=!1),d.push(r+L)}let h;if(d.length===0)h=i.start+i.end;else{h=d[0];for(let y=1;y<d.length;++y){let g=d[y];h+=g?`
${l}${g}`:`
`}}return n?(h+=`
`+Dn.indentComment(c(n),l),a&&a()):f&&o&&o(),h}function jA({comment:n,items:e},t,{flowChars:r,itemIndent:i,onComment:s}){let{indent:o,indentStep:a,flowCollectionPadding:l,options:{commentString:c}}=t;i+=a;let u=Object.assign({},t,{indent:i,inFlow:!0,type:null}),f=!1,d=0,h=[];for(let L=0;L<e.length;++L){let I=e[L],v=null;if(St.isNode(I))I.spaceBefore&&h.push(""),Oi(t,h,I.commentBefore,!1),I.comment&&(v=I.comment);else if(St.isPair(I)){let M=St.isNode(I.key)?I.key:null;M&&(M.spaceBefore&&h.push(""),Oi(t,h,M.commentBefore,!1),M.comment&&(f=!0));let b=St.isNode(I.value)?I.value:null;b?(b.comment&&(v=b.comment),b.commentBefore&&(f=!0)):I.value==null&&M&&M.comment&&(v=M.comment)}v&&(f=!0);let $=Hp.stringify(I,u,()=>v=null);L<e.length-1&&($+=","),v&&($+=Dn.lineComment($,i,c(v))),!f&&(h.length>d||$.includes(`
`))&&(f=!0),h.push($),d=h.length}let y,{start:g,end:m}=r;if(h.length===0)y=g+m;else if(f||(f=h.reduce((I,v)=>I+v.length+2,2)>MA.Collection.maxFlowStringSingleLineLength),f){y=g;for(let L of h)y+=L?`
${a}${o}${L}`:`
`;y+=`
${o}${m}`}else y=`${g}${l}${h.join(" ")}${l}${m}`;return n&&(y+=Dn.lineComment(y,o,c(n)),s&&s()),y}function Oi({indent:n,options:{commentString:e}},t,r,i){if(r&&i&&(r=r.replace(/^\n+/,"")),r){let s=Dn.indentComment(e(r),n);t.push(s.trimStart())}}Bp.stringifyCollection=FA});var dt=_(la=>{"use strict";var HA=oa(),BA=ia(),UA=Pn(),ht=W(),Ri=ft(),VA=ce();function jn(n,e){let t=ht.isScalar(e)?e.value:e;for(let r of n)if(ht.isPair(r)&&(r.key===e||r.key===t||ht.isScalar(r.key)&&r.key.value===t))return r}var aa=class extends UA.Collection{static get tagName(){return"tag:yaml.org,2002:map"}constructor(e){super(ht.MAP,e),this.items=[]}static from(e,t,r){let{keepUndefined:i,replacer:s}=r,o=new this(e),a=(l,c)=>{if(typeof s=="function")c=s.call(t,l,c);else if(Array.isArray(s)&&!s.includes(l))return;(c!==void 0||i)&&o.items.push(Ri.createPair(l,c,r))};if(t instanceof Map)for(let[l,c]of t)a(l,c);else if(t&&typeof t=="object")for(let l of Object.keys(t))a(l,t[l]);return typeof e.sortMapEntries=="function"&&o.items.sort(e.sortMapEntries),o}add(e,t){let r;ht.isPair(e)?r=e:!e||typeof e!="object"||!("key"in e)?r=new Ri.Pair(e,e?.value):r=new Ri.Pair(e.key,e.value);let i=jn(this.items,r.key),s=this.schema?.sortMapEntries;if(i){if(!t)throw new Error(`Key ${r.key} already set`);ht.isScalar(i.value)&&VA.isScalarValue(r.value)?i.value.value=r.value:i.value=r.value}else if(s){let o=this.items.findIndex(a=>s(r,a)<0);o===-1?this.items.push(r):this.items.splice(o,0,r)}else this.items.push(r)}delete(e){let t=jn(this.items,e);return t?this.items.splice(this.items.indexOf(t),1).length>0:!1}get(e,t){let i=jn(this.items,e)?.value;return(!t&&ht.isScalar(i)?i.value:i)??void 0}has(e){return!!jn(this.items,e)}set(e,t){this.add(new Ri.Pair(e,t),!0)}toJSON(e,t,r){let i=r?new r:t?.mapAsMap?new Map:{};t?.onCreate&&t.onCreate(i);for(let s of this.items)BA.addPairToJSMap(t,i,s);return i}toString(e,t,r){if(!e)return JSON.stringify(this);for(let i of this.items)if(!ht.isPair(i))throw new Error(`Map items must all be pairs; found ${JSON.stringify(i)} instead`);return!e.allNullValues&&this.hasAllNullValues(!1)&&(e=Object.assign({},e,{allNullValues:!0})),HA.stringifyCollection(this,e,{blockItemPrefix:"",flowChars:{start:"{",end:"}"},itemIndent:e.indent||"",onChompKeep:r,onComment:t})}};la.YAMLMap=aa;la.findPair=jn});var Wt=_(Vp=>{"use strict";var WA=W(),Up=dt(),GA={collection:"map",default:!0,nodeClass:Up.YAMLMap,tag:"tag:yaml.org,2002:map",resolve(n,e){return WA.isMap(n)||e("Expected a mapping for this tag"),n},createNode:(n,e,t)=>Up.YAMLMap.from(n,e,t)};Vp.map=GA});var pt=_(Wp=>{"use strict";var KA=Cn(),YA=oa(),JA=Pn(),Pi=W(),XA=ce(),zA=ot(),ca=class extends JA.Collection{static get tagName(){return"tag:yaml.org,2002:seq"}constructor(e){super(Pi.SEQ,e),this.items=[]}add(e){this.items.push(e)}delete(e){let t=Ci(e);return typeof t!="number"?!1:this.items.splice(t,1).length>0}get(e,t){let r=Ci(e);if(typeof r!="number")return;let i=this.items[r];return!t&&Pi.isScalar(i)?i.value:i}has(e){let t=Ci(e);return typeof t=="number"&&t<this.items.length}set(e,t){let r=Ci(e);if(typeof r!="number")throw new Error(`Expected a valid index, not ${e}.`);let i=this.items[r];Pi.isScalar(i)&&XA.isScalarValue(t)?i.value=t:this.items[r]=t}toJSON(e,t){let r=[];t?.onCreate&&t.onCreate(r);let i=0;for(let s of this.items)r.push(zA.toJS(s,String(i++),t));return r}toString(e,t,r){return e?YA.stringifyCollection(this,e,{blockItemPrefix:"- ",flowChars:{start:"[",end:"]"},itemIndent:(e.indent||"")+"  ",onChompKeep:r,onComment:t}):JSON.stringify(this)}static from(e,t,r){let{replacer:i}=r,s=new this(e);if(t&&Symbol.iterator in Object(t)){let o=0;for(let a of t){if(typeof i=="function"){let l=t instanceof Set?a:String(o++);a=i.call(t,l,a)}s.items.push(KA.createNode(a,void 0,r))}}return s}};function Ci(n){let e=Pi.isScalar(n)?n.value:n;return e&&typeof e=="string"&&(e=Number(e)),typeof e=="number"&&Number.isInteger(e)&&e>=0?e:null}Wp.YAMLSeq=ca});var Gt=_(Kp=>{"use strict";var QA=W(),Gp=pt(),ZA={collection:"seq",default:!0,nodeClass:Gp.YAMLSeq,tag:"tag:yaml.org,2002:seq",resolve(n,e){return QA.isSeq(n)||e("Expected a sequence for this tag"),n},createNode:(n,e,t)=>Gp.YAMLSeq.from(n,e,t)};Kp.seq=ZA});var Hn=_(Yp=>{"use strict";var eI=xn(),tI={identify:n=>typeof n=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:n=>n,stringify(n,e,t,r){return e=Object.assign({actualString:!0},e),eI.stringifyString(n,e,t,r)}};Yp.string=tI});var ki=_(zp=>{"use strict";var Jp=ce(),Xp={identify:n=>n==null,createNode:()=>new Jp.Scalar(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^(?:~|[Nn]ull|NULL)?$/,resolve:()=>new Jp.Scalar(null),stringify:({source:n},e)=>typeof n=="string"&&Xp.test.test(n)?n:e.options.nullStr};zp.nullTag=Xp});var ua=_(Zp=>{"use strict";var nI=ce(),Qp={identify:n=>typeof n=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,resolve:n=>new nI.Scalar(n[0]==="t"||n[0]==="T"),stringify({source:n,value:e},t){if(n&&Qp.test.test(n)){let r=n[0]==="t"||n[0]==="T";if(e===r)return n}return e?t.options.trueStr:t.options.falseStr}};Zp.boolTag=Qp});var Kt=_(e_=>{"use strict";function rI({format:n,minFractionDigits:e,tag:t,value:r}){if(typeof r=="bigint")return String(r);let i=typeof r=="number"?r:Number(r);if(!isFinite(i))return isNaN(i)?".nan":i<0?"-.inf":".inf";let s=JSON.stringify(r);if(!n&&e&&(!t||t==="tag:yaml.org,2002:float")&&/^\d/.test(s)){let o=s.indexOf(".");o<0&&(o=s.length,s+=".");let a=e-(s.length-o-1);for(;a-- >0;)s+="0"}return s}e_.stringifyNumber=rI});var ha=_($i=>{"use strict";var iI=ce(),fa=Kt(),sI={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF|nan|NaN|NAN))$/,resolve:n=>n.slice(-3).toLowerCase()==="nan"?NaN:n[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:fa.stringifyNumber},oI={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:\.[0-9]+|[0-9]+(?:\.[0-9]*)?)[eE][-+]?[0-9]+$/,resolve:n=>parseFloat(n),stringify(n){let e=Number(n.value);return isFinite(e)?e.toExponential():fa.stringifyNumber(n)}},aI={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,resolve(n){let e=new iI.Scalar(parseFloat(n)),t=n.indexOf(".");return t!==-1&&n[n.length-1]==="0"&&(e.minFractionDigits=n.length-t-1),e},stringify:fa.stringifyNumber};$i.float=aI;$i.floatExp=oI;$i.floatNaN=sI});var pa=_(xi=>{"use strict";var t_=Kt(),qi=n=>typeof n=="bigint"||Number.isInteger(n),da=(n,e,t,{intAsBigInt:r})=>r?BigInt(n):parseInt(n.substring(e),t);function n_(n,e,t){let{value:r}=n;return qi(r)&&r>=0?t+r.toString(e):t_.stringifyNumber(n)}var lI={identify:n=>qi(n)&&n>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^0o[0-7]+$/,resolve:(n,e,t)=>da(n,2,8,t),stringify:n=>n_(n,8,"0o")},cI={identify:qi,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9]+$/,resolve:(n,e,t)=>da(n,0,10,t),stringify:t_.stringifyNumber},uI={identify:n=>qi(n)&&n>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^0x[0-9a-fA-F]+$/,resolve:(n,e,t)=>da(n,2,16,t),stringify:n=>n_(n,16,"0x")};xi.int=cI;xi.intHex=uI;xi.intOct=lI});var i_=_(r_=>{"use strict";var fI=Wt(),hI=ki(),dI=Gt(),pI=Hn(),_I=ua(),_a=ha(),ma=pa(),mI=[fI.map,dI.seq,pI.string,hI.nullTag,_I.boolTag,ma.intOct,ma.int,ma.intHex,_a.floatNaN,_a.floatExp,_a.float];r_.schema=mI});var a_=_(o_=>{"use strict";var gI=ce(),yI=Wt(),EI=Gt();function s_(n){return typeof n=="bigint"||Number.isInteger(n)}var Mi=({value:n})=>JSON.stringify(n),TI=[{identify:n=>typeof n=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:n=>n,stringify:Mi},{identify:n=>n==null,createNode:()=>new gI.Scalar(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^null$/,resolve:()=>null,stringify:Mi},{identify:n=>typeof n=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^true|false$/,resolve:n=>n==="true",stringify:Mi},{identify:s_,default:!0,tag:"tag:yaml.org,2002:int",test:/^-?(?:0|[1-9][0-9]*)$/,resolve:(n,e,{intAsBigInt:t})=>t?BigInt(n):parseInt(n,10),stringify:({value:n})=>s_(n)?n.toString():JSON.stringify(n)},{identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^-?(?:0|[1-9][0-9]*)(?:\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$/,resolve:n=>parseFloat(n),stringify:Mi}],LI={default:!0,tag:"",test:/^/,resolve(n,e){return e(`Unresolved plain scalar ${JSON.stringify(n)}`),n}},SI=[yI.map,EI.seq].concat(TI,LI);o_.schema=SI});var ya=_(l_=>{"use strict";var ga=ce(),AI=xn(),II={identify:n=>n instanceof Uint8Array,default:!1,tag:"tag:yaml.org,2002:binary",resolve(n,e){if(typeof Buffer=="function")return Buffer.from(n,"base64");if(typeof atob=="function"){let t=atob(n.replace(/[\n\r]/g,"")),r=new Uint8Array(t.length);for(let i=0;i<t.length;++i)r[i]=t.charCodeAt(i);return r}else return e("This environment does not support reading binary tags; either Buffer or atob is required"),n},stringify({comment:n,type:e,value:t},r,i,s){let o=t,a;if(typeof Buffer=="function")a=o instanceof Buffer?o.toString("base64"):Buffer.from(o.buffer).toString("base64");else if(typeof btoa=="function"){let l="";for(let c=0;c<o.length;++c)l+=String.fromCharCode(o[c]);a=btoa(l)}else throw new Error("This environment does not support writing binary tags; either Buffer or btoa is required");if(e||(e=ga.Scalar.BLOCK_LITERAL),e!==ga.Scalar.QUOTE_DOUBLE){let l=Math.max(r.options.lineWidth-r.indent.length,r.options.minContentWidth),c=Math.ceil(a.length/l),u=new Array(c);for(let f=0,d=0;f<c;++f,d+=l)u[f]=a.substr(d,l);a=u.join(e===ga.Scalar.BLOCK_LITERAL?`
`:" ")}return AI.stringifyString({comment:n,type:e,value:a},r,i,s)}};l_.binary=II});var ji=_(Di=>{"use strict";var Fi=W(),Ea=ft(),wI=ce(),vI=pt();function c_(n,e){if(Fi.isSeq(n))for(let t=0;t<n.items.length;++t){let r=n.items[t];if(!Fi.isPair(r)){if(Fi.isMap(r)){r.items.length>1&&e("Each pair must have its own sequence indicator");let i=r.items[0]||new Ea.Pair(new wI.Scalar(null));if(r.commentBefore&&(i.key.commentBefore=i.key.commentBefore?`${r.commentBefore}
${i.key.commentBefore}`:r.commentBefore),r.comment){let s=i.value??i.key;s.comment=s.comment?`${r.comment}
${s.comment}`:r.comment}r=i}n.items[t]=Fi.isPair(r)?r:new Ea.Pair(r)}}else e("Expected a sequence for this tag");return n}function u_(n,e,t){let{replacer:r}=t,i=new vI.YAMLSeq(n);i.tag="tag:yaml.org,2002:pairs";let s=0;if(e&&Symbol.iterator in Object(e))for(let o of e){typeof r=="function"&&(o=r.call(e,String(s++),o));let a,l;if(Array.isArray(o))if(o.length===2)a=o[0],l=o[1];else throw new TypeError(`Expected [key, value] tuple: ${o}`);else if(o&&o instanceof Object){let c=Object.keys(o);if(c.length===1)a=c[0],l=o[a];else throw new TypeError(`Expected { key: value } tuple: ${o}`)}else a=o;i.items.push(Ea.createPair(a,l,t))}return i}var bI={collection:"seq",default:!1,tag:"tag:yaml.org,2002:pairs",resolve:c_,createNode:u_};Di.createPairs=u_;Di.pairs=bI;Di.resolvePairs=c_});var Sa=_(La=>{"use strict";var f_=W(),Ta=ot(),Bn=dt(),NI=pt(),h_=ji(),At=class n extends NI.YAMLSeq{constructor(){super(),this.add=Bn.YAMLMap.prototype.add.bind(this),this.delete=Bn.YAMLMap.prototype.delete.bind(this),this.get=Bn.YAMLMap.prototype.get.bind(this),this.has=Bn.YAMLMap.prototype.has.bind(this),this.set=Bn.YAMLMap.prototype.set.bind(this),this.tag=n.tag}toJSON(e,t){if(!t)return super.toJSON(e);let r=new Map;t?.onCreate&&t.onCreate(r);for(let i of this.items){let s,o;if(f_.isPair(i)?(s=Ta.toJS(i.key,"",t),o=Ta.toJS(i.value,s,t)):s=Ta.toJS(i,"",t),r.has(s))throw new Error("Ordered maps must not include duplicate keys");r.set(s,o)}return r}static from(e,t,r){let i=h_.createPairs(e,t,r),s=new this;return s.items=i.items,s}};At.tag="tag:yaml.org,2002:omap";var OI={collection:"seq",identify:n=>n instanceof Map,nodeClass:At,default:!1,tag:"tag:yaml.org,2002:omap",resolve(n,e){let t=h_.resolvePairs(n,e),r=[];for(let{key:i}of t.items)f_.isScalar(i)&&(r.includes(i.value)?e(`Ordered maps must not include duplicate keys: ${i.value}`):r.push(i.value));return Object.assign(new At,t)},createNode:(n,e,t)=>At.from(n,e,t)};La.YAMLOMap=At;La.omap=OI});var g_=_(Aa=>{"use strict";var d_=ce();function p_({value:n,source:e},t){return e&&(n?__:m_).test.test(e)?e:n?t.options.trueStr:t.options.falseStr}var __={identify:n=>n===!0,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/,resolve:()=>new d_.Scalar(!0),stringify:p_},m_={identify:n=>n===!1,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/i,resolve:()=>new d_.Scalar(!1),stringify:p_};Aa.falseTag=m_;Aa.trueTag=__});var y_=_(Hi=>{"use strict";var RI=ce(),Ia=Kt(),CI={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?\.(?:inf|Inf|INF|nan|NaN|NAN)$/,resolve:n=>n.slice(-3).toLowerCase()==="nan"?NaN:n[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:Ia.stringifyNumber},PI={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:[0-9][0-9_]*)?(?:\.[0-9_]*)?[eE][-+]?[0-9]+$/,resolve:n=>parseFloat(n.replace(/_/g,"")),stringify(n){let e=Number(n.value);return isFinite(e)?e.toExponential():Ia.stringifyNumber(n)}},kI={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,resolve(n){let e=new RI.Scalar(parseFloat(n.replace(/_/g,""))),t=n.indexOf(".");if(t!==-1){let r=n.substring(t+1).replace(/_/g,"");r[r.length-1]==="0"&&(e.minFractionDigits=r.length)}return e},stringify:Ia.stringifyNumber};Hi.float=kI;Hi.floatExp=PI;Hi.floatNaN=CI});var T_=_(Vn=>{"use strict";var E_=Kt(),Un=n=>typeof n=="bigint"||Number.isInteger(n);function Bi(n,e,t,{intAsBigInt:r}){let i=n[0];if((i==="-"||i==="+")&&(e+=1),n=n.substring(e).replace(/_/g,""),r){switch(t){case 2:n=`0b${n}`;break;case 8:n=`0o${n}`;break;case 16:n=`0x${n}`;break}let o=BigInt(n);return i==="-"?BigInt(-1)*o:o}let s=parseInt(n,t);return i==="-"?-1*s:s}function wa(n,e,t){let{value:r}=n;if(Un(r)){let i=r.toString(e);return r<0?"-"+t+i.substr(1):t+i}return E_.stringifyNumber(n)}var $I={identify:Un,default:!0,tag:"tag:yaml.org,2002:int",format:"BIN",test:/^[-+]?0b[0-1_]+$/,resolve:(n,e,t)=>Bi(n,2,2,t),stringify:n=>wa(n,2,"0b")},qI={identify:Un,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^[-+]?0[0-7_]+$/,resolve:(n,e,t)=>Bi(n,1,8,t),stringify:n=>wa(n,8,"0")},xI={identify:Un,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9][0-9_]*$/,resolve:(n,e,t)=>Bi(n,0,10,t),stringify:E_.stringifyNumber},MI={identify:Un,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^[-+]?0x[0-9a-fA-F_]+$/,resolve:(n,e,t)=>Bi(n,2,16,t),stringify:n=>wa(n,16,"0x")};Vn.int=xI;Vn.intBin=$I;Vn.intHex=MI;Vn.intOct=qI});var ba=_(va=>{"use strict";var Wi=W(),Ui=ft(),Vi=dt(),It=class n extends Vi.YAMLMap{constructor(e){super(e),this.tag=n.tag}add(e){let t;Wi.isPair(e)?t=e:e&&typeof e=="object"&&"key"in e&&"value"in e&&e.value===null?t=new Ui.Pair(e.key,null):t=new Ui.Pair(e,null),Vi.findPair(this.items,t.key)||this.items.push(t)}get(e,t){let r=Vi.findPair(this.items,e);return!t&&Wi.isPair(r)?Wi.isScalar(r.key)?r.key.value:r.key:r}set(e,t){if(typeof t!="boolean")throw new Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof t}`);let r=Vi.findPair(this.items,e);r&&!t?this.items.splice(this.items.indexOf(r),1):!r&&t&&this.items.push(new Ui.Pair(e))}toJSON(e,t){return super.toJSON(e,t,Set)}toString(e,t,r){if(!e)return JSON.stringify(this);if(this.hasAllNullValues(!0))return super.toString(Object.assign({},e,{allNullValues:!0}),t,r);throw new Error("Set items must all have null values")}static from(e,t,r){let{replacer:i}=r,s=new this(e);if(t&&Symbol.iterator in Object(t))for(let o of t)typeof i=="function"&&(o=i.call(t,o,o)),s.items.push(Ui.createPair(o,null,r));return s}};It.tag="tag:yaml.org,2002:set";var FI={collection:"map",identify:n=>n instanceof Set,nodeClass:It,default:!1,tag:"tag:yaml.org,2002:set",createNode:(n,e,t)=>It.from(n,e,t),resolve(n,e){if(Wi.isMap(n)){if(n.hasAllNullValues(!0))return Object.assign(new It,n);e("Set items must all have null values")}else e("Expected a mapping for this tag");return n}};va.YAMLSet=It;va.set=FI});var Oa=_(Gi=>{"use strict";var DI=Kt();function Na(n,e){let t=n[0],r=t==="-"||t==="+"?n.substring(1):n,i=o=>e?BigInt(o):Number(o),s=r.replace(/_/g,"").split(":").reduce((o,a)=>o*i(60)+i(a),i(0));return t==="-"?i(-1)*s:s}function L_(n){let{value:e}=n,t=o=>o;if(typeof e=="bigint")t=o=>BigInt(o);else if(isNaN(e)||!isFinite(e))return DI.stringifyNumber(n);let r="";e<0&&(r="-",e*=t(-1));let i=t(60),s=[e%i];return e<60?s.unshift(0):(e=(e-s[0])/i,s.unshift(e%i),e>=60&&(e=(e-s[0])/i,s.unshift(e))),r+s.map(o=>String(o).padStart(2,"0")).join(":").replace(/000000\d*$/,"")}var jI={identify:n=>typeof n=="bigint"||Number.isInteger(n),default:!0,tag:"tag:yaml.org,2002:int",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+$/,resolve:(n,e,{intAsBigInt:t})=>Na(n,t),stringify:L_},HI={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*$/,resolve:n=>Na(n,!1),stringify:L_},S_={identify:n=>n instanceof Date,default:!0,tag:"tag:yaml.org,2002:timestamp",test:RegExp("^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?$"),resolve(n){let e=n.match(S_.test);if(!e)throw new Error("!!timestamp expects a date, starting with yyyy-mm-dd");let[,t,r,i,s,o,a]=e.map(Number),l=e[7]?Number((e[7]+"00").substr(1,3)):0,c=Date.UTC(t,r-1,i,s||0,o||0,a||0,l),u=e[8];if(u&&u!=="Z"){let f=Na(u,!1);Math.abs(f)<30&&(f*=60),c-=6e4*f}return new Date(c)},stringify:({value:n})=>n.toISOString().replace(/((T00:00)?:00)?\.000Z$/,"")};Gi.floatTime=HI;Gi.intTime=jI;Gi.timestamp=S_});var w_=_(I_=>{"use strict";var BI=Wt(),UI=ki(),VI=Gt(),WI=Hn(),GI=ya(),A_=g_(),Ra=y_(),Ki=T_(),KI=Sa(),YI=ji(),JI=ba(),Ca=Oa(),XI=[BI.map,VI.seq,WI.string,UI.nullTag,A_.trueTag,A_.falseTag,Ki.intBin,Ki.intOct,Ki.int,Ki.intHex,Ra.floatNaN,Ra.floatExp,Ra.float,GI.binary,KI.omap,YI.pairs,JI.set,Ca.intTime,Ca.floatTime,Ca.timestamp];I_.schema=XI});var q_=_($a=>{"use strict";var O_=Wt(),zI=ki(),R_=Gt(),QI=Hn(),ZI=ua(),Pa=ha(),ka=pa(),ew=i_(),tw=a_(),C_=ya(),P_=Sa(),k_=ji(),v_=w_(),$_=ba(),Yi=Oa(),b_=new Map([["core",ew.schema],["failsafe",[O_.map,R_.seq,QI.string]],["json",tw.schema],["yaml11",v_.schema],["yaml-1.1",v_.schema]]),N_={binary:C_.binary,bool:ZI.boolTag,float:Pa.float,floatExp:Pa.floatExp,floatNaN:Pa.floatNaN,floatTime:Yi.floatTime,int:ka.int,intHex:ka.intHex,intOct:ka.intOct,intTime:Yi.intTime,map:O_.map,null:zI.nullTag,omap:P_.omap,pairs:k_.pairs,seq:R_.seq,set:$_.set,timestamp:Yi.timestamp},nw={"tag:yaml.org,2002:binary":C_.binary,"tag:yaml.org,2002:omap":P_.omap,"tag:yaml.org,2002:pairs":k_.pairs,"tag:yaml.org,2002:set":$_.set,"tag:yaml.org,2002:timestamp":Yi.timestamp};function rw(n,e){let t=b_.get(e);if(!t)if(Array.isArray(n))t=[];else{let r=Array.from(b_.keys()).filter(i=>i!=="yaml11").map(i=>JSON.stringify(i)).join(", ");throw new Error(`Unknown schema "${e}"; use one of ${r} or define customTags array`)}if(Array.isArray(n))for(let r of n)t=t.concat(r);else typeof n=="function"&&(t=n(t.slice()));return t.map(r=>{if(typeof r!="string")return r;let i=N_[r];if(i)return i;let s=Object.keys(N_).map(o=>JSON.stringify(o)).join(", ");throw new Error(`Unknown custom tag "${r}"; use one of ${s}`)})}$a.coreKnownTags=nw;$a.getTags=rw});var Ma=_(x_=>{"use strict";var qa=W(),iw=Wt(),sw=Gt(),ow=Hn(),Ji=q_(),aw=(n,e)=>n.key<e.key?-1:n.key>e.key?1:0,xa=class n{constructor({compat:e,customTags:t,merge:r,resolveKnownTags:i,schema:s,sortMapEntries:o,toStringDefaults:a}){this.compat=Array.isArray(e)?Ji.getTags(e,"compat"):e?Ji.getTags(null,e):null,this.merge=!!r,this.name=typeof s=="string"&&s||"core",this.knownTags=i?Ji.coreKnownTags:{},this.tags=Ji.getTags(t,this.name),this.toStringOptions=a??null,Object.defineProperty(this,qa.MAP,{value:iw.map}),Object.defineProperty(this,qa.SCALAR,{value:ow.string}),Object.defineProperty(this,qa.SEQ,{value:sw.seq}),this.sortMapEntries=typeof o=="function"?o:o===!0?aw:null}clone(){let e=Object.create(n.prototype,Object.getOwnPropertyDescriptors(this));return e.tags=this.tags.slice(),e}};x_.Schema=xa});var F_=_(M_=>{"use strict";var lw=W(),Fa=Mn(),Wn=kn();function cw(n,e){let t=[],r=e.directives===!0;if(e.directives!==!1&&n.directives){let l=n.directives.toString(n);l?(t.push(l),r=!0):n.directives.docStart&&(r=!0)}r&&t.push("---");let i=Fa.createStringifyContext(n,e),{commentString:s}=i.options;if(n.commentBefore){t.length!==1&&t.unshift("");let l=s(n.commentBefore);t.unshift(Wn.indentComment(l,""))}let o=!1,a=null;if(n.contents){if(lw.isNode(n.contents)){if(n.contents.spaceBefore&&r&&t.push(""),n.contents.commentBefore){let u=s(n.contents.commentBefore);t.push(Wn.indentComment(u,""))}i.forceBlockIndent=!!n.comment,a=n.contents.comment}let l=a?void 0:()=>o=!0,c=Fa.stringify(n.contents,i,()=>a=null,l);a&&(c+=Wn.lineComment(c,"",s(a))),(c[0]==="|"||c[0]===">")&&t[t.length-1]==="---"?t[t.length-1]=`--- ${c}`:t.push(c)}else t.push(Fa.stringify(n.contents,i));if(n.directives?.docEnd)if(n.comment){let l=s(n.comment);l.includes(`
`)?(t.push("..."),t.push(Wn.indentComment(l,""))):t.push(`... ${l}`)}else t.push("...");else{let l=n.comment;l&&o&&(l=l.replace(/^\n+/,"")),l&&((!o||a)&&t[t.length-1]!==""&&t.push(""),t.push(Wn.indentComment(s(l),"")))}return t.join(`
`)+`
`}M_.stringifyDocument=cw});var Gn=_(D_=>{"use strict";var uw=Rn(),Yt=Pn(),xe=W(),fw=ft(),hw=ot(),dw=Ma(),pw=F_(),Da=mi(),_w=Vo(),mw=Cn(),ja=Uo(),Ha=class n{constructor(e,t,r){this.commentBefore=null,this.comment=null,this.errors=[],this.warnings=[],Object.defineProperty(this,xe.NODE_TYPE,{value:xe.DOC});let i=null;typeof t=="function"||Array.isArray(t)?i=t:r===void 0&&t&&(r=t,t=void 0);let s=Object.assign({intAsBigInt:!1,keepSourceTokens:!1,logLevel:"warn",prettyErrors:!0,strict:!0,uniqueKeys:!0,version:"1.2"},r);this.options=s;let{version:o}=s;r?._directives?(this.directives=r._directives.atDocument(),this.directives.yaml.explicit&&(o=this.directives.yaml.version)):this.directives=new ja.Directives({version:o}),this.setSchema(o,r),this.contents=e===void 0?null:this.createNode(e,i,r)}clone(){let e=Object.create(n.prototype,{[xe.NODE_TYPE]:{value:xe.DOC}});return e.commentBefore=this.commentBefore,e.comment=this.comment,e.errors=this.errors.slice(),e.warnings=this.warnings.slice(),e.options=Object.assign({},this.options),this.directives&&(e.directives=this.directives.clone()),e.schema=this.schema.clone(),e.contents=xe.isNode(this.contents)?this.contents.clone(e.schema):this.contents,this.range&&(e.range=this.range.slice()),e}add(e){Jt(this.contents)&&this.contents.add(e)}addIn(e,t){Jt(this.contents)&&this.contents.addIn(e,t)}createAlias(e,t){if(!e.anchor){let r=Da.anchorNames(this);e.anchor=!t||r.has(t)?Da.findNewAnchor(t||"a",r):t}return new uw.Alias(e.anchor)}createNode(e,t,r){let i;if(typeof t=="function")e=t.call({"":e},"",e),i=t;else if(Array.isArray(t)){let m=I=>typeof I=="number"||I instanceof String||I instanceof Number,L=t.filter(m).map(String);L.length>0&&(t=t.concat(L)),i=t}else r===void 0&&t&&(r=t,t=void 0);let{aliasDuplicateObjects:s,anchorPrefix:o,flow:a,keepUndefined:l,onTagObj:c,tag:u}=r??{},{onAnchor:f,setAnchors:d,sourceObjects:h}=Da.createNodeAnchors(this,o||"a"),y={aliasDuplicateObjects:s??!0,keepUndefined:l??!1,onAnchor:f,onTagObj:c,replacer:i,schema:this.schema,sourceObjects:h},g=mw.createNode(e,u,y);return a&&xe.isCollection(g)&&(g.flow=!0),d(),g}createPair(e,t,r={}){let i=this.createNode(e,null,r),s=this.createNode(t,null,r);return new fw.Pair(i,s)}delete(e){return Jt(this.contents)?this.contents.delete(e):!1}deleteIn(e){return Yt.isEmptyPath(e)?this.contents==null?!1:(this.contents=null,!0):Jt(this.contents)?this.contents.deleteIn(e):!1}get(e,t){return xe.isCollection(this.contents)?this.contents.get(e,t):void 0}getIn(e,t){return Yt.isEmptyPath(e)?!t&&xe.isScalar(this.contents)?this.contents.value:this.contents:xe.isCollection(this.contents)?this.contents.getIn(e,t):void 0}has(e){return xe.isCollection(this.contents)?this.contents.has(e):!1}hasIn(e){return Yt.isEmptyPath(e)?this.contents!==void 0:xe.isCollection(this.contents)?this.contents.hasIn(e):!1}set(e,t){this.contents==null?this.contents=Yt.collectionFromPath(this.schema,[e],t):Jt(this.contents)&&this.contents.set(e,t)}setIn(e,t){Yt.isEmptyPath(e)?this.contents=t:this.contents==null?this.contents=Yt.collectionFromPath(this.schema,Array.from(e),t):Jt(this.contents)&&this.contents.setIn(e,t)}setSchema(e,t={}){typeof e=="number"&&(e=String(e));let r;switch(e){case"1.1":this.directives?this.directives.yaml.version="1.1":this.directives=new ja.Directives({version:"1.1"}),r={merge:!0,resolveKnownTags:!1,schema:"yaml-1.1"};break;case"1.2":case"next":this.directives?this.directives.yaml.version=e:this.directives=new ja.Directives({version:e}),r={merge:!1,resolveKnownTags:!0,schema:"core"};break;case null:this.directives&&delete this.directives,r=null;break;default:{let i=JSON.stringify(e);throw new Error(`Expected '1.1', '1.2' or null as first argument, but found: ${i}`)}}if(t.schema instanceof Object)this.schema=t.schema;else if(r)this.schema=new dw.Schema(Object.assign(r,t));else throw new Error("With a null YAML version, the { schema: Schema } option is required")}toJS({json:e,jsonArg:t,mapAsMap:r,maxAliasCount:i,onAnchor:s,reviver:o}={}){let a={anchors:new Map,doc:this,keep:!e,mapAsMap:r===!0,mapKeyWarned:!1,maxAliasCount:typeof i=="number"?i:100},l=hw.toJS(this.contents,t??"",a);if(typeof s=="function")for(let{count:c,res:u}of a.anchors.values())s(u,c);return typeof o=="function"?_w.applyReviver(o,{"":l},"",l):l}toJSON(e,t){return this.toJS({json:!0,jsonArg:e,mapAsMap:!1,onAnchor:t})}toString(e={}){if(this.errors.length>0)throw new Error("Document with errors cannot be stringified");if("indent"in e&&(!Number.isInteger(e.indent)||Number(e.indent)<=0)){let t=JSON.stringify(e.indent);throw new Error(`"indent" option must be a positive integer, not ${t}`)}return pw.stringifyDocument(this,e)}};function Jt(n){if(xe.isCollection(n))return!0;throw new Error("Expected a YAML collection as document contents")}D_.Document=Ha});var Jn=_(Yn=>{"use strict";var Kn=class extends Error{constructor(e,t,r,i){super(),this.name=e,this.code=r,this.message=i,this.pos=t}},Ba=class extends Kn{constructor(e,t,r){super("YAMLParseError",e,t,r)}},Ua=class extends Kn{constructor(e,t,r){super("YAMLWarning",e,t,r)}},gw=(n,e)=>t=>{if(t.pos[0]===-1)return;t.linePos=t.pos.map(a=>e.linePos(a));let{line:r,col:i}=t.linePos[0];t.message+=` at line ${r}, column ${i}`;let s=i-1,o=n.substring(e.lineStarts[r-1],e.lineStarts[r]).replace(/[\n\r]+$/,"");if(s>=60&&o.length>80){let a=Math.min(s-39,o.length-79);o="\u2026"+o.substring(a),s-=a-1}if(o.length>80&&(o=o.substring(0,79)+"\u2026"),r>1&&/^ *$/.test(o.substring(0,s))){let a=n.substring(e.lineStarts[r-2],e.lineStarts[r-1]);a.length>80&&(a=a.substring(0,79)+`\u2026
...
`+k.comment:G.comment=k.comment);let F=new Pw.Pair(G,j);if(t.options.keepSourceTokens&&(F.srcToken=L),o){let D=c;xw.mapIncludes(t,D.items,G)&&i(V,"DUPLICATE_KEY","Map keys must be unique"),D.items.push(F)}else{let D=new em.YAMLMap(t.schema);D.flow=!0,D.items.push(F),c.items.push(D)}f=j?j.range[2]:k.end}}let d=o?"}":"]",[h,...y]=r.end,g=f;if(h&&h.source===d)g=h.offset+h.source.length;else{let m=a[0].toUpperCase()+a.substring(1),L=u?`${m} must end with a ${d}`:`${m} in block collection must be sufficiently indented and end with a ${d}`;i(f,u?"MISSING_CHAR":"BAD_INDENT",L),h&&h.source.length!==1&&y.unshift(h)}if(y.length>0){let m=$w.resolveEnd(y,g,t.options.strict,i);m.comment&&(c.comment?c.comment+=`
`+m.comment:c.comment=m.comment),c.range=[r.offset,g,m.offset]}else c.range=[r.offset,g,g];return c}nm.resolveFlowCollection=Mw});var sm=_(im=>{"use strict";var Fw=W(),Dw=ce(),jw=dt(),Hw=pt(),Bw=X_(),Uw=Q_(),Vw=rm();function Ja(n,e,t,r,i,s){let o=t.type==="block-map"?Bw.resolveBlockMap(n,e,t,r,s):t.type==="block-seq"?Uw.resolveBlockSeq(n,e,t,r,s):Vw.resolveFlowCollection(n,e,t,r,s),a=o.constructor;return i==="!"||i===a.tagName?(o.tag=a.tagName,o):(i&&(o.tag=i),o)}function Ww(n,e,t,r,i){let s=r?e.directives.tagName(r.source,f=>i(r,"TAG_RESOLVE_FAILED",f)):null,o=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!r||!s||s==="!"||s===jw.YAMLMap.tagName&&o==="map"||s===Hw.YAMLSeq.tagName&&o==="seq"||!o)return Ja(n,e,t,i,s);let a=e.schema.tags.find(f=>f.tag===s&&f.collection===o);if(!a){let f=e.schema.knownTags[s];if(f&&f.collection===o)e.schema.tags.push(Object.assign({},f,{default:!1})),a=f;else return f?.collection?i(r,"BAD_COLLECTION_TYPE",`${f.tag} used for ${o} collection, but expects ${f.collection}`,!0):i(r,"TAG_RESOLVE_FAILED",`Unresolved tag: ${s}`,!0),Ja(n,e,t,i,s)}let l=Ja(n,e,t,i,s,a),c=a.resolve?.(l,f=>i(r,"TAG_RESOLVE_FAILED",f),e.options)??l,u=Fw.isNode(c)?c:new Dw.Scalar(c);return u.range=l.range,u.tag=s,a?.format&&(u.format=a.format),u}im.composeCollection=Ww});var za=_(om=>{"use strict";var Xa=ce();function Gw(n,e,t){let r=n.offset,i=Kw(n,e,t);if(!i)return{value:"",type:null,comment:"",range:[r,r,r]};let s=i.mode===">"?Xa.Scalar.BLOCK_FOLDED:Xa.Scalar.BLOCK_LITERAL,o=n.source?Yw(n.source):[],a=o.length;for(let g=o.length-1;g>=0;--g){let m=o[g][1];if(m===""||m==="\r")a=g;else break}if(a===0){let g=i.chomp==="+"&&o.length>0?`
...
`&&(f+=`
`);break;default:f+=`
`}let y=r+i.length+n.source.length;return{value:f,type:s,comment:i.comment,range:[r,y,y]}}function Kw({offset:n,props:e},t,r){if(e[0].type!=="block-scalar-header")return r(e[0],"IMPOSSIBLE","Block scalar header not found"),null;let{source:i}=e[0],s=i[0],o=0,a="",l=-1;for(let d=1;d<i.length;++d){let h=i[d];if(!a&&(h==="-"||h==="+"))a=h;else{let y=Number(h);!o&&y?o=y:l===-1&&(l=n+d)}}l!==-1&&r(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let c=!1,u="",f=i.length;for(let d=1;d<e.length;++d){let h=e[d];switch(h.type){case"space":c=!0;case"newline":f+=h.source.length;break;case"comment":t&&!c&&r(h,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),f+=h.source.length,u=h.source.substring(1);break;case"error":r(h,"UNEXPECTED_TOKEN",h.message),f+=h.source.length;break;default:{let y=`Unexpected token in block scalar header: ${h.type}`;r(h,"UNEXPECTED_TOKEN",y);let g=h.source;g&&typeof g=="string"&&(f+=g.length)}}}return{mode:s,indent:o,chomp:a,comment:u,length:f}}function Yw(n){let e=n.split(/\n( *)/),t=e[0],r=t.match(/^( *)/),s=[r?.[1]?[r[1],t.slice(r[1].length)]:["",t]];for(let o=1;o<e.length;o+=2)s.push([e[o],e[o+1]]);return s}om.resolveBlockScalar=Gw});var Za=_(lm=>{"use strict";var Qa=ce(),Jw=Xt();function Xw(n,e,t){let{offset:r,type:i,source:s,end:o}=n,a,l,c=(d,h,y)=>t(r+d,h,y);switch(i){case"scalar":a=Qa.Scalar.PLAIN,l=zw(s,c);break;case"single-quoted-scalar":a=Qa.Scalar.QUOTE_SINGLE,l=Qw(s,c);break;case"double-quoted-scalar":a=Qa.Scalar.QUOTE_DOUBLE,l=Zw(s,c);break;default:return t(n,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[r,r+s.length,r+s.length]}}let u=r+s.length,f=Jw.resolveEnd(o,u,e,t);return{value:l,type:a,comment:f.comment,range:[r,u,f.offset]}}function zw(n,e){let t="";switch(n[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${n[0]}`;break}case"@":case"`":{t=`reserved character ${n[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),am(n)}function Qw(n,e){return(n[n.length-1]!=="'"||n.length===1)&&e(n.length,"MISSING_CHAR","Missing closing 'quote"),am(n.slice(1,-1)).replace(/''/g,"'")}function am(n){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
...
`))if(i===`
`){let{fold:s,offset:o}=ev(n,r);t+=s,r=o}else if(i==="\\"){let s=n[++r],o=tv[s];if(o)t+=o;else if(s===`
`)for(s=n[r+1];s===" "||s==="	";)s=n[++r+1];else if(s==="\r"&&n[r+1]===`
`)for(s=n[++r+1];s===" "||s==="	";)s=n[++r+1];else if(s==="x"||s==="u"||s==="U"){let a={x:2,u:4,U:8}[s];t+=nv(n,r+1,a,e),r+=a}else{let a=n.substr(r-1,2);e(r-1,"BAD_DQ_ESCAPE",`Invalid escape sequence ${a}`),t+=a}}else if(i===" "||i==="	"){let s=r,o=n[r+1];for(;o===" "||o==="	";)o=n[++r+1];o!==`
`&&!(o==="\r"&&n[r+2]===`
`)&&(t+=r>s?n.slice(s,r+1):i)}else t+=i}return(n[n.length-1]!=='"'||n.length===1)&&e(n.length,"MISSING_CHAR",'Missing closing "quote'),t}function ev(n,e){let t="",r=n[e+1];for(;(r===" "||r==="	"||r===`
`||r==="\r")&&!(r==="\r"&&n[e+2]!==`
`);)r===`
`&&(t+=`
`),e+=1,r=n[e+1];return t||(t=" "),{fold:t,offset:e}}var tv={0:"\0",a:"\x07",b:"\b",e:"\x1B",f:"\f",n:`
`,r:"\r",t:"	",v:"\v",N:"\x85",_:"\xA0",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function nv(n,e,t,r){let i=n.substr(e,t),o=i.length===t&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;if(isNaN(o)){let a=n.substr(e-2,t+2);return r(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${a}`),a}return String.fromCodePoint(o)}lm.resolveFlowScalar=Xw});var fm=_(um=>{"use strict";var zt=W(),cm=ce(),rv=za(),iv=Za();function sv(n,e,t,r){let{value:i,type:s,comment:o,range:a}=e.type==="block-scalar"?rv.resolveBlockScalar(e,n.options.strict,r):iv.resolveFlowScalar(e,n.options.strict,r),l=t?n.directives.tagName(t.source,f=>r(t,"TAG_RESOLVE_FAILED",f)):null,c=t&&l?ov(n.schema,i,l,t,r):e.type==="scalar"?av(n,i,e,r):n.schema[zt.SCALAR],u;try{let f=c.resolve(i,d=>r(t??e,"TAG_RESOLVE_FAILED",d),n.options);u=zt.isScalar(f)?f:new cm.Scalar(f)}catch(f){let d=f instanceof Error?f.message:String(f);r(t??e,"TAG_RESOLVE_FAILED",d),u=new cm.Scalar(i)}return u.range=a,u.source=i,s&&(u.type=s),l&&(u.tag=l),c.format&&(u.format=c.format),o&&(u.comment=o),u}function ov(n,e,t,r,i){if(t==="!")return n[zt.SCALAR];let s=[];for(let a of n.tags)if(!a.collection&&a.tag===t)if(a.default&&a.test)s.push(a);else return a;for(let a of s)if(a.test?.test(e))return a;let o=n.knownTags[t];return o&&!o.collection?(n.tags.push(Object.assign({},o,{default:!1,test:void 0})),o):(i(r,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),n[zt.SCALAR])}function av({directives:n,schema:e},t,r,i){let s=e.tags.find(o=>o.default&&o.test?.test(t))||e[zt.SCALAR];if(e.compat){let o=e.compat.find(a=>a.default&&a.test?.test(t))??e[zt.SCALAR];if(s.tag!==o.tag){let a=n.tagString(s.tag),l=n.tagString(o.tag),c=`Value may be parsed as either ${a} or ${l}`;i(r,"TAG_RESOLVE_FAILED",c,!0)}}return s}um.composeScalar=sv});var dm=_(hm=>{"use strict";function lv(n,e,t){if(e){t===null&&(t=e.length);for(let r=t-1;r>=0;--r){let i=e[r];switch(i.type){case"space":case"comment":case"newline":n-=i.source.length;continue}for(i=e[++r];i?.type==="space";)n+=i.source.length,i=e[++r];break}}return n}hm.emptyScalarPosition=lv});var mm=_(tl=>{"use strict";var cv=Rn(),uv=sm(),pm=fm(),fv=Xt(),hv=dm(),dv={composeNode:_m,composeEmptyNode:el};function _m(n,e,t,r){let{spaceBefore:i,comment:s,anchor:o,tag:a}=t,l,c=!0;switch(e.type){case"alias":l=pv(n,e,r),(o||a)&&r(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":l=pm.composeScalar(n,e,a,r),o&&(l.anchor=o.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":l=uv.composeCollection(dv,n,e,a,r),o&&(l.anchor=o.source.substring(1));break;default:{let u=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;r(e,"UNEXPECTED_TOKEN",u),l=el(n,e.offset,void 0,null,t,r),c=!1}}return o&&l.anchor===""&&r(o,"BAD_ALIAS","Anchor cannot be an empty string"),i&&(l.spaceBefore=!0),s&&(e.type==="scalar"&&e.source===""?l.comment=s:l.commentBefore=s),n.options.keepSourceTokens&&c&&(l.srcToken=e),l}function el(n,e,t,r,{spaceBefore:i,comment:s,anchor:o,tag:a,end:l},c){let u={type:"scalar",offset:hv.emptyScalarPosition(e,t,r),indent:-1,source:""},f=pm.composeScalar(n,u,a,c);return o&&(f.anchor=o.source.substring(1),f.anchor===""&&c(o,"BAD_ALIAS","Anchor cannot be an empty string")),i&&(f.spaceBefore=!0),s&&(f.comment=s,f.range[2]=l),f}function pv({options:n},{offset:e,source:t,end:r},i){let s=new cv.Alias(t.substring(1));s.source===""&&i(e,"BAD_ALIAS","Alias cannot be an empty string"),s.source.endsWith(":")&&i(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);let o=e+t.length,a=fv.resolveEnd(r,o,n.strict,i);return s.range=[e,o,a.offset],a.comment&&(s.comment=a.comment),s}tl.composeEmptyNode=el;tl.composeNode=_m});var Em=_(ym=>{"use strict";var _v=Gn(),gm=mm(),mv=Xt(),gv=Xn();function yv(n,e,{offset:t,start:r,value:i,end:s},o){let a=Object.assign({_directives:e},n),l=new _v.Document(void 0,a),c={atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},u=gv.resolveProps(r,{indicator:"doc-start",next:i??s?.[0],offset:t,onError:o,startOnNewline:!0});u.found&&(l.directives.docStart=!0,i&&(i.type==="block-map"||i.type==="block-seq")&&!u.hasNewline&&o(u.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=i?gm.composeNode(c,i,u,o):gm.composeEmptyNode(c,u.end,r,null,u,o);let f=l.contents.range[2],d=mv.resolveEnd(s,f,!1,o);return d.comment&&(l.comment=d.comment),l.range=[t,f,d.offset],l}ym.composeDoc=yv});var rl=_(Sm=>{"use strict";var Ev=Uo(),Tv=Gn(),zn=Jn(),Tm=W(),Lv=Em(),Sv=Xt();function Qn(n){if(typeof n=="number")return[n,n+1];if(Array.isArray(n))return n.length===2?n:[n[0],n[1]];let{offset:e,source:t}=n;return[e,e+(typeof t=="string"?t.length:1)]}function Lm(n){let e="",t=!1,r=!1;for(let i=0;i<n.length;++i){let s=n[i];switch(s[0]){case"#":e+=(e===""?"":r?`

`:`
`)+(s.substring(1)||" "),t=!0,r=!1;break;case"%":n[i+1]?.[0]!=="#"&&(i+=1),t=!1;break;default:t||(r=!0),t=!1}}return{comment:e,afterEmptyLine:r}}var nl=class{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,r,i,s)=>{let o=Qn(t);s?this.warnings.push(new zn.YAMLWarning(o,r,i)):this.errors.push(new zn.YAMLParseError(o,r,i))},this.directives=new Ev.Directives({version:e.version||"1.2"}),this.options=e}decorate(e,t){let{comment:r,afterEmptyLine:i}=Lm(this.prelude);if(r){let s=e.contents;if(t)e.comment=e.comment?`${e.comment}
...
${o}`:r}}t?(Array.prototype.push.apply(e.errors,this.errors),Array.prototype.push.apply(e.warnings,this.warnings)):(e.errors=this.errors,e.warnings=this.warnings),this.prelude=[],this.errors=[],this.warnings=[]}streamInfo(){return{comment:Lm(this.prelude).comment,directives:this.directives,errors:this.errors,warnings:this.warnings}}*compose(e,t=!1,r=-1){for(let i of e)yield*this.next(i);yield*this.end(t,r)}*next(e){switch(process.env.LOG_STREAM&&console.dir(e,{depth:null}),e.type){case"directive":this.directives.add(e.source,(t,r,i)=>{let s=Qn(e);s[0]+=t,this.onError(s,"BAD_DIRECTIVE",r,i)}),this.prelude.push(e.source),this.atDirectives=!0;break;case"document":{let t=Lv.composeDoc(this.options,this.directives,e,this.onError);this.atDirectives&&!t.directives.docStart&&this.onError(e,"MISSING_CHAR","Missing directives-end/doc-start indicator line"),this.decorate(t,!1),this.doc&&(yield this.doc),this.doc=t,this.atDirectives=!1;break}case"byte-order-mark":case"space":break;case"comment":case"newline":this.prelude.push(e.source);break;case"error":{let t=e.source?`${e.message}: ${JSON.stringify(e.source)}`:e.message,r=new zn.YAMLParseError(Qn(e),"UNEXPECTED_TOKEN",t);this.atDirectives||!this.doc?this.errors.push(r):this.doc.errors.push(r);break}case"doc-end":{if(!this.doc){let r="Unexpected doc-end without preceding document";this.errors.push(new zn.YAMLParseError(Qn(e),"UNEXPECTED_TOKEN",r));break}this.doc.directives.docEnd=!0;let t=Sv.resolveEnd(e.end,e.offset+e.source.length,this.doc.options.strict,this.onError);if(this.decorate(this.doc,!0),t.comment){let r=this.doc.comment;this.doc.comment=r?`${r}
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new zn.YAMLParseError(Qn(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){let r=Object.assign({_directives:this.directives},this.options),i=new Tv.Document(void 0,r);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),i.range=[0,t,t],this.decorate(i,!1),yield i}}};Sm.Composer=nl});var wm=_(zi=>{"use strict";var Av=za(),Iv=Za(),wv=Jn(),Am=xn();function vv(n,e=!0,t){if(n){let r=(i,s,o)=>{let a=typeof i=="number"?i:Array.isArray(i)?i[0]:i.offset;if(t)t(a,s,o);else throw new wv.YAMLParseError([a,a+1],s,o)};switch(n.type){case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":return Iv.resolveFlowScalar(n,e,r);case"block-scalar":return Av.resolveBlockScalar(n,e,r)}}return null}function bv(n,e){let{implicitKey:t=!1,indent:r,inFlow:i=!1,offset:s=-1,type:o="PLAIN"}=e,a=Am.stringifyString({type:o,value:n},{implicitKey:t,indent:r>0?" ".repeat(r):"",inFlow:i,options:{blockQuote:!0,lineWidth:-1}}),l=e.end??[{type:"newline",offset:-1,indent:r,source:`
...
`}),{type:"block-scalar",offset:s,indent:r,props:d,source:f}}case'"':return{type:"double-quoted-scalar",offset:s,indent:r,source:a,end:l};case"'":return{type:"single-quoted-scalar",offset:s,indent:r,source:a,end:l};default:return{type:"scalar",offset:s,indent:r,source:a,end:l}}}function Nv(n,e,t={}){let{afterKey:r=!1,implicitKey:i=!1,inFlow:s=!1,type:o}=t,a="indent"in n?n.indent:null;if(r&&typeof a=="number"&&(a+=2),!o)switch(n.type){case"single-quoted-scalar":o="QUOTE_SINGLE";break;case"double-quoted-scalar":o="QUOTE_DOUBLE";break;case"block-scalar":{let c=n.props[0];if(c.type!=="block-scalar-header")throw new Error("Invalid block scalar header");o=c.source[0]===">"?"BLOCK_FOLDED":"BLOCK_LITERAL";break}default:o="PLAIN"}let l=Am.stringifyString({type:o,value:e},{implicitKey:i||a===null,indent:a!==null&&a>0?" ".repeat(a):"",inFlow:s,options:{blockQuote:!0,lineWidth:-1}});switch(l[0]){case"|":case">":Ov(n,l);break;case'"':il(n,l,"double-quoted-scalar");break;case"'":il(n,l,"single-quoted-scalar");break;default:il(n,l,"scalar")}}function Ov(n,e){let t=e.indexOf(`
...
`};delete n.items,Object.assign(n,{type:t,source:e,end:[i]});break}default:{let r="indent"in n?n.indent:-1,i="end"in n&&Array.isArray(n.end)?n.end.filter(s=>s.type==="space"||s.type==="comment"||s.type==="newline"):[];for(let s of Object.keys(n))s!=="type"&&s!=="offset"&&delete n[s];Object.assign(n,{type:t,indent:r,source:e,end:i})}}}zi.createScalarToken=bv;zi.resolveAsScalar=vv;zi.setScalarValue=Nv});var bm=_(vm=>{"use strict";var Rv=n=>"type"in n?Zi(n):Qi(n);function Zi(n){switch(n.type){case"block-scalar":{let e="";for(let t of n.props)e+=Zi(t);return e+n.source}case"block-map":case"block-seq":{let e="";for(let t of n.items)e+=Qi(t);return e}case"flow-collection":{let e=n.start.source;for(let t of n.items)e+=Qi(t);for(let t of n.end)e+=t.source;return e}case"document":{let e=Qi(n);if(n.end)for(let t of n.end)e+=t.source;return e}default:{let e=n.source;if("end"in n&&n.end)for(let t of n.end)e+=t.source;return e}}}function Qi({start:n,key:e,sep:t,value:r}){let i="";for(let s of n)i+=s.source;if(e&&(i+=Zi(e)),t)for(let s of t)i+=s.source;return r&&(i+=Zi(r)),i}vm.stringify=Rv});var Cm=_(Rm=>{"use strict";var sl=Symbol("break visit"),Cv=Symbol("skip children"),Nm=Symbol("remove item");function wt(n,e){"type"in n&&n.type==="document"&&(n={start:n.start,value:n.value}),Om(Object.freeze([]),n,e)}wt.BREAK=sl;wt.SKIP=Cv;wt.REMOVE=Nm;wt.itemAtPath=(n,e)=>{let t=n;for(let[r,i]of e){let s=t?.[r];if(s&&"items"in s)t=s.items[i];else return}return t};wt.parentCollection=(n,e)=>{let t=wt.itemAtPath(n,e.slice(0,-1)),r=e[e.length-1][0],i=t?.[r];if(i&&"items"in i)return i;throw new Error("Parent collection not found")};function Om(n,e,t){let r=t(e,n);if(typeof r=="symbol")return r;for(let i of["key","value"]){let s=e[i];if(s&&"items"in s){for(let o=0;o<s.items.length;++o){let a=Om(Object.freeze(n.concat([[i,o]])),s.items[o],t);if(typeof a=="number")o=a-1;else{if(a===sl)return sl;a===Nm&&(s.items.splice(o,1),o-=1)}}typeof r=="function"&&i==="key"&&(r=r(e,n))}}return typeof r=="function"?r(e,n):r}Rm.visit=wt});var es=_(Re=>{"use strict";var ol=wm(),Pv=bm(),kv=Cm(),al="\uFEFF",ll="",cl="",ul="",$v=n=>!!n&&"items"in n,qv=n=>!!n&&(n.type==="scalar"||n.type==="single-quoted-scalar"||n.type==="double-quoted-scalar"||n.type==="block-scalar");function xv(n){switch(n){case al:return"<BOM>";case ll:return"<DOC>";case cl:return"<FLOW_END>";case ul:return"<SCALAR>";default:return JSON.stringify(n)}}function Mv(n){switch(n){case al:return"byte-order-mark";case ll:return"doc-mode";case cl:return"flow-error-end";case ul:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
`:return"newline";case"-":return"seq-item-ind";case"?":return"explicit-key-ind";case":":return"map-value-ind";case"{":return"flow-map-start";case"}":return"flow-map-end";case"[":return"flow-seq-start";case"]":return"flow-seq-end";case",":return"comma"}switch(n[0]){case" ":case"	":return"space";case"#":return"comment";case"%":return"directive-line";case"*":return"alias";case"&":return"anchor";case"!":return"tag";case"'":return"single-quoted-scalar";case'"':return"double-quoted-scalar";case"|":case">":return"block-scalar-header"}return null}Re.createScalarToken=ol.createScalarToken;Re.resolveAsScalar=ol.resolveAsScalar;Re.setScalarValue=ol.setScalarValue;Re.stringify=Pv.stringify;Re.visit=kv.visit;Re.BOM=al;Re.DOCUMENT=ll;Re.FLOW_END=cl;Re.SCALAR=ul;Re.isCollection=$v;Re.isScalar=qv;Re.prettyToken=xv;Re.tokenType=Mv});var pl=_(km=>{"use strict";var Zn=es();function Me(n){switch(n){case void 0:case" ":case`
`:case"\r":case"	":return!0;default:return!1}}var Pm="0123456789ABCDEFabcdef".split(""),Fv="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()".split(""),fl=",[]{}".split(""),Dv=` ,[]{}
\r	`.split(""),hl=n=>!n||Dv.includes(n),dl=class{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){e&&(this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null),this.atEnd=!t;let r=this.next??"stream";for(;r&&(t||this.hasChars(1));)r=yield*this.parseNext(r)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
...
0xCA0  KANNADA LETTER TTHA
 ...
 $\\___/$ @
         @@
         `;var _r=se(Sc()),Vg=_r.default.green,Wg=_r.default.yellow,Gg=_r.default.bold.red;function Ac(n){let e=Vg(`${n.passed.length} validation passed`),t=Gg(`${n.failed.length} validation failed`),r=n.warning.length>0?Wg(`${n.warning.length} warning(s)`):void 0;n.failed.length===0?console.log(`\u2705[${n.name}] ${e}${r?`, ${r}`:""}.`):(console.log(`\u274C[${n.name}] ${t}${r?`, ${r}`:""}, ${e}.`),console.log(n.failed.map(i=>`  \u274C ${i}`).join(`
`))),n.warning.length>0&&console.log(n.warning.map(i=>`  \u26A0\uFE0F ${i}`).join(`
`)),n.passed.length>0&&console.log(n.passed.map(i=>`  \u2705 ${i}`).join(`
`))}var Of=se(Nc()),Js=se(it()),Xs=se(require("path"));var Et=se(it()),qt=se(require("path"));function bf(n){let e=[],t=process.env.SAMPLE_VALIDATOR_CONFIG_PATH;return t&&Et.default.existsSync(t)&&e.push(t),e.push(qt.default.join(n,"..",".config","samples-config-v3.json"),qt.default.join(n,".config","samples-config-v3.json")),e}function xt(n){let e=process.env.SAMPLE_VALIDATOR_EXPECTED_ID;return e||qt.default.basename(n)}async function Nf(n){let e=xt(n),t=bf(n);for(let r of t)if(await Et.default.exists(r))try{let s=(await Et.default.readJson(r)).samples.find(o=>o.id===e);if(s)return{thumbnailPath:s.thumbnailPath,gifPath:s.gifPath}}catch{}return{}}async function _E(n){let e=xt(n),t=bf(n);for(let r of t)if(await Et.default.exists(r))try{let s=(await Et.default.readJson(r)).samples.find(o=>o.id===e);if(s&&s.tags)return s.tags.includes("C#")}catch{}return!1}async function Ue(n){let e=await _E(n),t=qt.default.join(n,"M365Agent"),r=qt.default.join(t,"m365agents.yml"),i=await Et.default.exists(r);return e||i?{projectType:"csharp",rootDir:n,agentDir:i?t:n,displayPrefix:i?"M365Agent/":""}:{projectType:"typescript",rootDir:n,agentDir:n,displayPrefix:""}}async function zs(n){let e={name:"Env Files",passed:[],failed:[],warning:[]},t=await Ue(n),{agentDir:r,displayPrefix:i,projectType:s}=t,o=[".env.dev",".env.local"],a=!1;for(let l of o){let c=Xs.default.join(r,"env",l);if(!await Js.default.exists(c)){if(s==="csharp")continue;e.warning.push(`${i}${Xs.default.join("env",l)} does not exist.`);continue}a=!0;let u=await Js.default.readFile(c,"utf8"),f=Of.default.parse(u),d=Object.entries(f).map(([y,g])=>({name:y,value:g})),h=!0;for(let y of d)y.name==="TEAMSFX_ENV"||y.name==="APP_NAME_SUFFIX"||y.name==="TEAMS_APP_NAME"||y.name.startsWith("connectionsMap__0")||y.name.startsWith("agentic_")||y.value!==""&&(e.failed.push(`${i}${l}: ${y.name} should NOT have value.`),h=!1);h&&e.passed.push(`${i}${l}: All environment variables are valid.`)}return s==="csharp"&&!a&&e.passed.push("C# project does not require env files."),e}var st=se(it()),dn=se(require("path"));var mE=["appPackage"],gE=["appPackage/manifest.json","appPackage/color.png","appPackage/outline.png","m365agents.yml","m365agents.local.yml"],yE=["README.md"],EE=["env/.env.dev"],TE=["env",".vscode"];async function Qs(n,e){let t=dn.default.join(n,e);return await st.default.exists(t)?(await st.default.stat(t)).isDirectory():!1}async function Mt(n,e){let t=dn.default.join(n,e);return await st.default.exists(t)?(await st.default.stat(t)).isFile():!1}async function br(n,e){return await st.default.exists(n)?(await st.default.readdir(n)).filter(r=>r.endsWith(e)):[]}async function Zs(n){let e={name:"Folder Structure",passed:[],failed:[],warning:[]},t=await Ue(n),{agentDir:r,rootDir:i,displayPrefix:s,projectType:o}=t;for(let a of mE){let l=s+a;await Qs(r,a)?e.passed.push(`Project has "${l}" folder.`):e.failed.push(`Project should have "${l}" folder.`)}for(let a of TE){let l=await Qs(r,a),c=await Qs(i,a);if(l||c){let u=l?s+a:a;e.passed.push(`Project has "${u}" folder.`)}else o==="typescript"&&e.failed.push(`Project should have "${a}" folder.`)}for(let a of gE){let l=s+a;await Mt(r,a)?e.passed.push(`Project has "${l}" file.`):e.failed.push(`Project should have "${l}" file.`)}for(let a of yE)await Mt(i,a)?e.passed.push(`Project has "${a}" file.`):e.failed.push(`Project should have "${a}" file.`);for(let a of EE){let l=await Mt(r,a),c=await Mt(i,a);if(l||c){let u=l?s+a:a;e.passed.push(`Project has "${u}" file.`)}else o==="typescript"&&e.failed.push(`Project should have "${a}" file.`)}if(o==="csharp"){let a=await br(i,".sln"),l=await br(i,".slnx");if(a.length>0||l.length>0){let g=a.length>0?a[0]:l[0];e.passed.push(`Project has solution file "${g}".`)}else e.failed.push("C# project should have a .sln or .slnx solution file.");let c=await br(i,".csproj"),u=c.length>0,f=c.length>0?c[0]:"",d=["M365Agent","TravelAgent","AzureAgentToM365ATK"];for(let g of d){let m=dn.default.join(i,g);if(await st.default.exists(m)){let L=await br(m,".csproj");if(L.length>0){u=!0,f=`${g}/${L[0]}`;break}}}u?e.passed.push(`Project has .csproj file "${f}".`):e.failed.push("C# project should have a .csproj project file.");let h=await Mt(i,"appsettings.json"),y="appsettings.json";if(!h)for(let g of d){let m=dn.default.join(i,g);if(await Mt(m,"appsettings.json")){h=!0,y=`${g}/appsettings.json`;break}}h?e.passed.push(`Project has "${y}" file.`):e.failed.push("C# project should have an appsettings.json file.")}return e}var mn=se(it()),gn=se(require("path")),yn=se(hh());function j1(n){return xt(n).endsWith("-codespaces")}async function _o(n){let e={name:"Image Files",passed:[],failed:[],warning:[]},t=j1(n),r=await Nf(n);if(t)e.passed.push("Thumbnail validation skipped for codespaces sample (not in samples-config-v3.json).");else if(r.thumbnailPath){let i=gn.default.join(n,r.thumbnailPath);if(await mn.default.exists(i)){let s=(0,yn.default)(i);s.width&&s.height&&s.width/s.height===40/23?e.passed.push(`${r.thumbnailPath} has 1600*920/800*460 resolution or same ratio.`):e.failed.push(`${r.thumbnailPath} must have 1600*920/800*460 resolution or same ratio (40:23 aspect ratio). Current: ${s.width}x${s.height}.`)}else e.failed.push(`${r.thumbnailPath} is required to display in sample gallery but does not exist.`)}else{let i=["png","jpg","jpeg"],s=!1;for(let o of i){let a=gn.default.join(n,"assets",`thumbnail.${o}`);if(await mn.default.exists(a)){s=!0;let l=(0,yn.default)(a);l.width&&l.height&&l.width/l.height===40/23?e.passed.push(`assets/thumbnail.${o} has 1600*920/800*460 resolution or same ratio.`):e.failed.push(`assets/thumbnail.${o} must have 1600*920/800*460 resolution or same ratio (40:23 aspect ratio). Current: ${l.width}x${l.height}.`);break}}s||e.failed.push("Thumbnail image is required to display in sample gallery. Please add thumbnailPath to samples-config-v3.json or add assets/thumbnail.png.")}if(r.gifPath){let i=gn.default.join(n,r.gifPath);if(await mn.default.exists(i)){let s=(0,yn.default)(i);s.width&&s.height&&s.width/s.height===40/23?e.passed.push(`${r.gifPath} has 1600*920/800*460 resolution or same ratio.`):e.warning.push(`${r.gifPath} does not have 40:23 aspect ratio. Current: ${s.width}x${s.height}. (Optional)`)}else e.warning.push(`${r.gifPath} does not exist. (Optional)`)}else{let i=gn.default.join(n,"assets","sampleDemo.gif");if(await mn.default.exists(i)){let s=(0,yn.default)(i);s.width&&s.height&&s.width/s.height===40/23?e.passed.push("assets/sampleDemo.gif has 1600*920/800*460 resolution or same ratio."):e.warning.push(`assets/sampleDemo.gif does not have 40:23 aspect ratio. Current: ${s.width}x${s.height}. (Optional)`)}else e.warning.push("Sample demo gif does not exist. (Optional)")}return e}var _h=se(ph()),mo=se(it()),mh=se(require("path"));async function go(n){let e={name:"package.json",passed:[],failed:[],warning:[]},t=await Ue(n),{projectType:r}=t,i=mh.default.join(n,"package.json");if(!await mo.default.exists(i))return r==="csharp"?(e.passed=["C# project does not require package.json."],e):(e.failed=["package.json does not exist."],e);let s=await mo.default.readFile(i,"utf8");try{let o=JSON.parse(s);if(!o.engines||!o.engines.node)return e.warning=["package.json does not have 'engines.node' field."],e;if(!(0,_h.satisfies)("22.0.0",o.engines.node))return e.warning=["'engines.node' field should be compatible with 22."],e}catch{return e.failed=["package.json is not a valid JSON file."],e}return e.passed=["'engines.node' field is compatible with 22."],e}var Mo=se(it()),ap=se(require("path")),Fo=se(xo());var sp="1.22.0",op="devPreview";async function Do(n){let e={name:"App Manifest",passed:[],failed:[],warning:[]},t=await Ue(n),{agentDir:r,displayPrefix:i}=t,s=ap.default.join(r,"appPackage","manifest.json");if(!await Mo.default.exists(s))return e.failed=[`${i}appPackage/manifest.json does not exist.`],e;let o=await Mo.default.readFile(s,"utf8"),a;try{a=JSON.parse(o)}catch{}if(!a)return e.failed.push("appPackage/manifest.json is not a valid JSON file."),e;let l=a.id;if(!l||l!=="${{TEAMS_APP_ID}}"?e.failed.push("id should be equal to '${{TEAMS_APP_ID}}'."):e.passed.push("id is referencing placeholder from env: ${{TEAMS_APP_ID}}."),a.manifestVersion===op)e.warning.push(`Manifest version(${op}) is using preview version.`);else{let c=Fo.default.coerce(a.manifestVersion);c&&Fo.default.eq(c,sp)?e.passed.push("Manifest version is aligned with Microsoft 365 Agents Toolkit."):e.warning.push(`Manifest version(${a.manifestVersion}) is NOT aligned with Microsoft 365 Agents Toolkit(${sp}).`)}return e}var Zt=se(it()),rs=se(require("path")),Km=se(Gm()),Tl=se(xo());var sb={"bot-sso-docker":"sso-bot-docker","NPM-search-connector-M365":"npm-search-connector-M365","sso-enabled-tab-via-apim-proxy":"sso-tab-via-apim-proxy","hello-world-tab-docker":"hello-world-tab-with-backend","copilot-connector-app":"graph-connector-app","graph-rsc-helper":"graph-rsc-nodeJs"};function ob(n){let e=[],t=process.env.SAMPLE_VALIDATOR_CONFIG_PATH;return t&&Zt.default.existsSync(t)&&e.push(t),e.push(rs.default.join(n,"..",".config","samples-config-v3.json"),rs.default.join(n,".config","samples-config-v3.json")),e}async function ab(n){let e=xt(n),t=ob(n);for(let r of t)if(await Zt.default.exists(r))try{let s=(await Zt.default.readJson(r)).samples.find(o=>o.id===e);if(s)return s.id}catch{}return null}var lb=[{name:"provision",actions:["teamsApp/create"],required:!0},{name:"deploy",actions:[],required:!0}],cb=[{name:"publish",actions:["teamsApp/publishAppPackage"]}],ub="1.2.0";async function Ll(n){let e={name:"teamsapp.yaml",passed:[],failed:[],warning:[]},t=await Ue(n),{agentDir:r,displayPrefix:i}=t,s=rs.default.join(r,"m365agents.yml");if(!await Zt.default.exists(s))return e.failed=[`${i}m365agents.yml does not exist.`],e;let o=await Zt.default.readFile(s,"utf8"),a=Km.default.parse(o),l=a&&a.projectId;l&&l!==""?e.failed.push("Project should NOT have projectId in m365agents.yml."):e.passed.push("Project has no projectId in m365agents.yml.");let c=a?.version;if(c){let y=c.match(/^v?(\d+)(?:\.(\d+))?/);if(y){let g=y[1],m=y[2]||"0",L=`${g}.${m}.0`,I=Tl.default.coerce(L);I&&Tl.default.gte(I,ub)?e.passed.push(`Version (${c}) supports sampleTag (>= v1.2).`):e.failed.push(`Version (${c}) must be >= v1.2 to support sampleTag.`)}else e.failed.push(`Version (${c}) is not a valid version format.`)}else e.failed.push("Project should have version field in m365agents.yml.");for(let y of lb){let g=a[y.name],m=[];if(!g){e.failed.push(`Project should have '${y.name}' stage in m365agents.yml.`);continue}for(let L of y.actions)if(g&&g.findIndex(I=>I.uses===L)<0&&m.push(`Project should have '${L}' action in ${y.name} stage.`),y.name==="provision"&&L==="teamsApp/create"){let I=g.findIndex(v=>v.uses===L);I>=0&&(g[I].writeToEnvironmentFile?.teamsAppId==="TEAMS_APP_ID"?e.passed.push("Project has 'teamsApp/create' action which has TEAMS_APP_ID env variable."):e.failed.push("Project should have 'teamsApp/create' action which has TEAMS_APP_ID env variable."))}m.length===0?e.passed.push(`Project has all mandatory actions in ${y.name} stage.`):e.failed.push(...m)}for(let y of cb){let g=a[y.name];if(!g){e.warning.push(`Project does not have '${y.name}' stage in m365agents.yml.`);continue}let m=!0;for(let L of y.actions)g.findIndex(I=>I.uses===L)<0&&(e.warning.push(`Project does not have '${L}' action in ${y.name} stage.`),m=!1);m&&e.passed.push(`Project has all actions in ${y.name} stage.`)}let u=/^([\w-]+):([\w-]+)$/g,f=a?.additionalMetadata?.sampleTag,d=await ab(n),h=!1;if(f&&f!==""){let y=u.exec(f);if(y){let g=y[1],m=y[2];if(e.passed.push("Project has sampleTag with format 'repo:name'."),h=!0,g!=="TeamsFx-Samples"&&e.warning.push("Project is an external sample."),d!==null){let L=sb[d];m===d||m===L?m===L?e.passed.push(`sampleTag name '${m}' matches allowed exception for sample id '${d}'.`):e.passed.push(`sampleTag name '${m}' matches sample id in config.`):e.failed.push(`sampleTag name '${m}' does not match sample id '${d}' in samples-config-v3.json.`)}}}return h||e.failed.push("Project should have sampleTag with format 'repo:name'."),e}var hb=Ym(),Jm=new Dl,db=[Zs,Ll,Do,zs,_o,go];async function pb(){await Jm.version(hb.version).description("A tool to validate project content before onboarding to TeamsFx sample gallery.").option("-p, --path <path>","Path to the project folder to be validated.").parseAsync(process.argv);let n=Jm.opts(),e=process.cwd();n.path&&typeof n.path=="string"&&(e=n.path);for(let t of db){let r=await t(e);Ac(r)}}is.parseFont("Standard",Ul);console.log(is.textSync("TeamsFx Sample Validator"));pb();
